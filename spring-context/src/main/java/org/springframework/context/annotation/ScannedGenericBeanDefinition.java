...
public class ScannedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	...
	/*
	本应返回 FactoryMethod
	但是由于是 ScannedGenericBeanDefinition，它是一个扫描类，所以不会有 FactoryMethod
	FactoryMethod 只存在 XML 中，或者手工注册 FactoryBean，提供 FactoryMethod
	但是这些不属于 ScannedGenericBeanDefinition 的范畴内
	 */
	@Override
	@Nullable
