...
/**
 * BeanDefinition 的一个实现类，同时也继承了 BeanMetadataAttributeAccessor，实现了 AttributeAccessor
 *
 *
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	// 是否抽象
	// 相当于创建一个 BeanDefinition 模板，其他 BeanDefinition 可以继承该模板
	...
	@Nullable
	private String[] dependsOn; // 存储 dependsOn 的名字
